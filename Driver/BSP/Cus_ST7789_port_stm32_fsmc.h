#ifndef __CUS_ST7789_FSMC_H__
#define __CUS_ST7789_FSMC_H__
...
/* ***************** LCD_Conf ***************** */
  ...
  #define LCD_DAT_ADDR                     (*(volatile uint16_t *)(LCD_BASE | (0x01 << 19)))
...
/* ***************** FSMC_Param_Conf ***************** */
  #define FSMC_READ_ADDR_SETUP_TIME        (0x0F)
  #define FSMC_READ_ADDR_HOLD_TIME         (0x00)
  #define FSMC_READ_DATA_SETUP_TIME        (0x3C)

  #define FSMC_WRITE_ADDR_SETUP_TIME       (0x09)
  #define FSMC_WRITE_ADDR_HOLD_TIME        (0x00)
  #define FSMC_WRITE_DATA_SETUP_TIME       (0x08)

  #define FSMC_ACCESS_MODE                 (FSMC_ACCESS_MODE_A)
  #define FSMC_BUS_AROUND_DURATION         (0x00)
  #define FSMC_NSBANK                      (FSMC_NORSRAM_BANK1)
/* ***************** FSMC_Param_Conf ***************** */ 
